...
"""
    Padrão para nome de variáveis: O nome de variáveis em Python segue o padrão 'Snake_Case', diferente de linguagens
    como o Java que seguem o padrão 'CamelCase'
"""
